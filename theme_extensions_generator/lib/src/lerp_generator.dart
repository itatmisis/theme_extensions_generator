...
class TransformModel {
  ...
  bool operator ==(Object other) =>
      other is TransformModel && other.targetType == targetType;
}

extension ToLerpModels on List<String> {
  Iterable<TransformModel> toLerpModels() {
    return expand<TransformModel>(
        (element) => [TransformModel(DataType(element))]);
  }
}

/// Holds interpolation rules and resolves how to transform a type.
class LerpGenerator {
  static final List<TransformModel> _initialTweenDataTypeNames = [
    ...Constants.typeNamesTween.toLerpModels()
  ];
  static final List<TransformModel> _initialLerpDataTypeNames = [
    ...Constants.typeNamesLerp.toLerpModels()
  ];

  final List<TransformModel> _tweenDataTypeNames = [
    ..._initialTweenDataTypeNames
  ];
  final List<TransformModel> _lerpDataTypeNames = [
    ..._initialLerpDataTypeNames
  ];
