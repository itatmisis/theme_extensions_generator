...
@ShouldGenerate(r'class _ActionButtonTheme implements ActionButtonTheme', contains: true)
...
@ShouldGenerate(r'class CustomThemeExtension extends ThemeExtension<CustomThemeExtension>', contains: true)
@ThemeExtended()
