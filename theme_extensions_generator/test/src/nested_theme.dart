...
@ShouldGenerate(r'class _NestedButtonTheme implements NestedButtonTheme', contains: true)
...
@ShouldGenerate(r'class ComplexThemeExtension extends ThemeExtension<ComplexThemeExtension>', contains: true)
@ThemeExtended()
class ComplexTheme with _$ComplexTheme {
  const factory ComplexTheme({
    @ThemeProperty.styled()
    required NestedButtonTheme buttonTheme,
  }) = _ComplexTheme;
}